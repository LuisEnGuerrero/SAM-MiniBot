...
(function () {
  ...
  // =====================================================
  if (window.__SAM_MINIBOT_LOADED__) {
    return;
  }
  window.__SAM_MINIBOT_LOADED__ = true;
  ...
  // =====================================================
  // 8️⃣ POSTMESSAGE HANDLER
  // =====================================================
  function bindMessages() {
    window.addEventListener('message', (event) => {
      if (!event.data || !event.data.type) return;

      if (event.data.type === 'SAM_MINIBOT_CLOSE') {
        toggleWidget(false);
      }
    });
  }
